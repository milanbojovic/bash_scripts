...
TEMPLATE_NAME="MBSOFTWARE_SOLUTIONS_INVOICE_TEMPLATE.docx"
...
sed -i "s/INV_NUM/$MONTH/" $TARGET_FILE_NAME
sed -i "s/YEAR/$YEAR/" $TARGET_FILE_NAME
sed -i "s/FDM/01.$MONTH./" $TARGET_FILE_NAME
